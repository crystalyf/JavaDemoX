package com.change.javaandroidtry.okhttpthree.eiken;
...
public class ENRequestBase {
    ...
    public enum API {
        ...
        LOGOUT("Logout"),
        SET_AUTH_MAIL("SetAuthMail"),
        CHECK_PIN_CODE("CheckPinCode"),
        CHECK_USER_ID("CheckUserId"),
        SET_USER_DATA("SetUserData"),
        REQUEST_CHANGE_PASSWORD("RequestChangePassword"),
        CHECK_CHANGE_PASSWORD("CheckChangePassword"),
        CHANGE_PASSWORD("ChangePassword"),
        GET_STUDY_GEAR_COUPON_TICKET("GetStudyGearCouponTicket"),
        CHECK_BASIC_COUPON("CheckBasicCoupon"),
    ...
    private ENRequestBase(Builder builder) {
        ...
        httpRequest = new Request.Builder()
                .post(body)
                .url("https://dev-bke.ei-navi.jp/bke/api/index.php")
                .build();
    }
